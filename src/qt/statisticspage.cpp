...
void StatisticsPage::updateStatistics()
{
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " LTS" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " LTS" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " LTS");
    }
