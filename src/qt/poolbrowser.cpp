...
const QString kBaseUrl3 = "https://bittrex.com/api/v1/public/getorderbook?market=BTC-LTS&type=both&depth=10";
QString lastp = "";
QString askp = "";
QString bidp = "";
QString highp = "";
...
{
    QDesktopServices::openUrl(QUrl("https://www.bittrex.com/Market/Index?MarketName=BTC-LTS"));
}
...
void PoolBrowser::parseNetworkResponse( QNetworkReply *finished )
{
    ...
    QStringList data2 = data.split("{\"MarketName\":\"BTC-LTS\",\"High\":");
