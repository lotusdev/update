...
{
    if(Height > pindexBest->nHeight) { return "0x00000d4c6fc481a89c9ba4bad220f59e52edbcbae7b801c6bbb5425aeb70dd69"; }
    if(Height < 0) { return "0x00000d4c6fc481a89c9ba4bad220f59e52edbcbae7b801c6bbb5425aeb70dd69"; }
    int desiredheight;
...
{    
    ...
    if(block == false) {
        ...
        ui->valueBox->setText(QValue + " LTS");
        ui->txID->setText(QID);
        ui->outputBox->setText(QOutputs);
        ui->inputBox->setText(QInputs);
        ui->feesBox->setText(QFees + " LTS");
    }
}
