...
int64 nChainStartTime = 1404046959;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1) {
     nSubsidy = 268860 * COIN; // IPO and PREMINE block
    } else if(nHeight <= 100) {
	nSubsidy = 1 * COIN; // first 100 blocks are 1 coin reward
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "29 June 2014 With each click on adverts you like, we redirect advertisement fees to fight cancer.";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1404046959;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 873957;
       if (fTestNet){ 
        block.nTime    = 1303022125;
        block.nNonce   = 17160;
        }  
        ...
        assert(block.hashMerkleRoot == uint256("0x79b07bfc7e9a24cff3a93943cfe211edf5a57f6a7dbd9f1ade1d57b262ace44c"));
...
unsigned char pchMessageStart[4] = { 0x81, 0x63, 0x46, 0x29 };
